...
namespace ev
{
	...
	{
		std::shared_ptr<ShaderModule> vertex_shader = ShaderModule::Create(device, "../Engine/assets/shaders/vert.spv");
		std::shared_ptr<ShaderModule> fragment_shader = ShaderModule::Create(device, "../Engine/assets/shaders/frag.spv");
